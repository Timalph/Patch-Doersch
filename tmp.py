...
# =============================================================================
    ...
    for i, clust in enumerate(ds['batch']['round']['selectedClust']):
        ...
        dispdetscell = dispdetscell.append(mydispdets.iloc[ord5[list(range(10)) + list(range(14, min(len(ord5), 100), 7))]], ignore_index=True)
    ...
    tooOldClusts = np.array(ds['batch']['round']['selectedClust'])[np.array(ds['batch']['round']['selClustIts']) >= num_train_its]
    try:
